...
public class MethodDeclaration extends Declaration {
    ...
    public MethodDeclaration(DLTKToken function_t, DLTKToken name) {
        super(name, function_t.getColumn(), name.getColumn() + name.getText().length());
    }
    
    public MethodDeclaration(String name, int nameStart, int nameEnd, int declStart, int declEnd) {
    ...
    public void acceptArguments(ArgumentList params) {
    ...
    public void printNode(CorePrinter output) {
        ...
        if (this.arguments != null && this.arguments.getArguments().size() > 0) {
            this.arguments.printNode(output);
        }
        output.formatPrintLn(")");
        if (this.body != null) {
    ...
    public boolean equals(Object obj) {
        ...
        // Only name.
        return d.getName().equals(this.getName()) && d.getNameStart() == this.getNameStart()
                && d.getNameEnd() == this.getNameEnd()
                && (this.declaringTypeName == null || this.declaringTypeName.equals(d.declaringTypeName));
    }
}
