...
public class PythonSourceParser {
    ...
    public ModuleDeclaration parse(char[] fileName, char[] content0, IProblemReporter reporter) {// throws
        ...
        PythonModuleDeclaration moduleDeclaration = new PythonModuleDeclaration(content0.length, true);
        ...
        pythonParser.reporter = new DLTKPythonErrorReporter(pythonParser.converter, problemReporter,
                pythonParser);
