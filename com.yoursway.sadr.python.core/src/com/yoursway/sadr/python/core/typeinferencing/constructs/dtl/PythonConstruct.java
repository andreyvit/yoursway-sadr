...
import com.yoursway.sadr.python.core.typeinferencing.constructs.AbstractConstruct;
...
public abstract class PythonConstruct<N extends ASTNode> extends AbstractConstruct {
    
    protected final N node;
    
    public PythonConstruct(StaticContext sc, N node) {
        super(sc);
        this.node = node;
    }
